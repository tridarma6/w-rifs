		...
		<>
			...
			<div className="flex w-1260 mt-20">
				<div className="flex flex-col items-start w-489 h-218">
					...
					<Link href="#" className="mt-4" underline="always">Contact Us<Image alt="image" className="ml-2 w-3 h-3" src="arrow-right-up.svg"/></Link>
				</div>
				<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8 justify-end w-648 left-675 h-323">
					<div className="w-full flex justify-center items-center border-solid border-2 rounded-xl border-black w-200 h-130"><Image alt="image" src="julias-berger-image.svg"/></div>
      				<div className="w-full flex justify-center items-center border-solid border-2 rounded-xl border-black w-182 h-161"><Image alt="image" src="julias-berger-image.svg"/></div>
      				<div className="w-full flex justify-center items-center border-solid border-2 rounded-xl border-black w-200 h-130"><Image alt="image" src="julias-berger-image.svg"/></div>
      				<div className="w-full flex justify-center items-center border-solid border-2 rounded-xl border-black w-200 h-130"><Image alt="image" src="julias-berger-2.svg"/></div>
      				<div className="w-full flex justify-center items-center border-solid border-2 rounded-xl border-black w-200 h-130"><Image alt="image" src="julias-berger-2.svg"/></div>
      				<div className="w-full flex justify-center items-center border-solid border-2 rounded-xl border-regal-blue w-200 h-130"><Image alt="image" src="add-image.svg"/></div>
				</div>
			</div>

			<div className="mt-44">
				<div className="flex justify-center ml-[550px]">
					<Image alt="image" src="star2.svg" width={40} height={40} className="transform rotate-16.82"/>
				</div>
			...
			<div className="container mt-28">
				<div className="w-[1187px] h-[486px] flex justify-between bg-regal-blue border-hidden border-2 border-regal-blue rounded-[20px]">
					<div className="relative bg-regal-blue w-[593.5px] text-white m-0 rounded-l-[20px]">
						<Image alt="image" src="banner-blue.svg" className="z-0"/>
...
const CompetitionGreen: React.FC<CompetitionProps> = ({srcImage, text, judul}) => {
	return(
		<>
		<div className={`w-[1187px] h-[486px] flex justify-between bg-biru-hijau border-hidden border-2 border-${srcImage} rounded-[20px] mt-16`}>
			<div className={`relative bg-biru-hijau w-[593.5px] text-white m-0 rounded-l-[20px]`}>
				<Image src={srcImage} className="z-0" alt="image"/>
				<div className="absolute inset-0 bottom-0 flex justify-center items-stretch">
					<p className="text-white text-[48px] font-bold z-10 self-end mx-10 my-10 tracking-[0.1em]">
						{judul}
					</p>
				</div>
			</div>
			<div className={`relative bg-biru-hijau w-[593.5px] text-white m-0 rounded-r-[20px]`}>
				<div className="ml-[52.1px] mr-10 mt-[-0.21px] mt-[49.93px]">
					<p className="font-rubik font-normal text-[20px] text-white flex items-center leading-9">
						{text}
					</p>
				</div>
				<div className="static flex gap-6">
...
const CompetitionBlue: React.FC<CompetitionProps> = ({srcImage, text, judul}) => {
	return(
		<>
		<div className={`w-[1187px] h-[486px] flex justify-between bg-regal-blue border-hidden border-2 border-${srcImage} rounded-[20px] mt-16`}>
			<div className={`relative bg-regal-blue w-[593.5px] text-white m-0 rounded-l-[20px]`}>
				<Image src={srcImage} className="z-0" alt="image"/>
				<div className="absolute inset-0 bottom-0 flex justify-center items-stretch">
					<p className="text-white text-[48px] font-bold z-10 self-end mx-10 my-10 tracking-[0.1em]">
